...
input0 = st.number_input("🍬 Bonbons (g)", min_value=0, step=5)
kcal_input0 = input0 * 4.0
input1 = st.number_input("🍪 Kekse (g)", min_value=0, step=5)
kcal_input1 = input1 * 5.0

if kcal_input0 + kcal_input1 > 0:
    st.info(f"📊 Gesamt: **{kcal_input0 + kcal_input1:.1f} kcal** "
            f"(🍬 Bonbons: {kcal_input0:.1f} kcal + 🍪 Kekse: {kcal_input1:.1f} kcal)")
