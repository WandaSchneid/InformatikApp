...
# 🔁 Zurück zur Ernährung (Cloud-kompatibel)
...
if kcal_input0 + kcal_input1 > 0:
    st.info(f"📊 Gesamt: **{kcal_input0 + kcal_input1:.1f} kcal** "
            f"(🍌 Banane: {kcal_input0:.1f} kcal + 🍓 Erdbeeren: {kcal_input1:.1f} kcal)")
...
category_ids = df_category[df_category["description"].str.contains(
    r"Fruits and Fruit Juices", case=False, regex=True)]["id"].unique()
